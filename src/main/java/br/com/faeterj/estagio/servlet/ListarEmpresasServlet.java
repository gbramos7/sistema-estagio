...
@WebServlet("/ListarEmpresasServlet")
public class ListarEmpresasServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Busca apenas EMPRESAS
        UsuarioDAO dao = new UsuarioDAO();
        List<Usuario> lista = dao.listarPorTipo("empresa");
        
        request.setAttribute("empresas", lista);
        request.getRequestDispatcher("/lista_empresas.jsp").forward(request, response);
    }
}